...
const transitionVariants = {
  ...
  enter: { opacity: 1, scale: 1, transition: { duration: 0.7, ease: "easeInOut" } },
  exit: { opacity: 0, scale: 0.8, transition: { duration: 0.7, ease: "easeInOut", delay: 1.5 } }, 
};
...
export default function DragonTransition({ children }: { children: React.ReactNode }) {
    ...
    <AnimatePresence mode="wait">
      <div key={pathname} className="min-h-screen"> 
        ...
        >
          ...
          <motion.div
            className="w-full h-full absolute bg-red-600/70"
          ...
          <motion.img
            ...
            className="w-48 h-auto relative z-60 mb-6" // Adjusted size and Z-index to be above fire
          ...
          {/* 4. Loading Text */}
          <h1 className="text-white text-5xl font-['Pirata_One'] relative z-60">
            Loading Map...
          </h1>
