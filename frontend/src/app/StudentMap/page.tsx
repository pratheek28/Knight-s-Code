...
const StudentMap = () => {
  ...
  return (
    // 1. Root Container
    <div className="relative flex min-h-screen w-screen items-center justify-center bg-gray-900">
      ...
      <div className="relative z-10 aspect-video max-h-[90vh] w-full max-w-[90vw] border-4 border-[#4b350f] lg:border-8">
        ...
        <header className="absolute top-4 right-0 left-0 z-20 mx-auto w-[calc(100%-2rem)] max-w-lg rounded-lg bg-gray-900/40 p-4 text-center shadow-xl backdrop-blur-sm">
          ...
          <h1 className="font-['Pirata_One'] text-4xl font-extrabold tracking-widest text-yellow-300 uppercase drop-shadow-[0_0_5px_rgba(255,200,0,0.8)]">
